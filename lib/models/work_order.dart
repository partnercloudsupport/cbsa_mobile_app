class WorkOrderModel {
  ...
  WorkOrderModel(this._firstName, this._lastName, this._otherNames, this._uuid, this._territory, this._subTerritory, this._block,
  ...
  this._archiveStage, this._createdAt, this._updatedAt, this._workOrderId, this._installationDate);
  ...
  String get toiletInstallationDate => _installationDate;

  WorkOrderModel.map(dynamic object) {
    this._id = object['id'];
  ...
  WorkOrderModel.fromMap(Map<String, dynamic> map) {
    this._id = map['id'];
    ...
    this._installationDate = map['installationdate'];
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    map['installationdate'] = _installationDate;
