class HICustomer {
  ...
  HICustomer(this._customerId, this._firstName, this._lastName, this._otherNames, this._uuid, this._territory, this._subTerritory, this._block,
  ...
  HICustomer.fromMap(Map<String, dynamic> map) {
    this._id = map['id'];
