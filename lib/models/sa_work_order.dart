class SAWorkOrderModel {
  ...
  SAWorkOrderModel(this._firstName, this._lastName, this._otherNames, this._uuid, this._territory, this._subTerritory, this._block,
  ...
  this._archiveStage, this._createdAt, this._updatedAt, this._workOrderId, this._transportDate);
  ...
  String get transportDate => _transportDate;

  SAWorkOrderModel.map(dynamic object) {
    this._id = object['id'];
    ...
    this._transportDate = object['transportdate'];
  }

  SAWorkOrderModel.fromMap(Map<String, dynamic> map) {
    this._id = map['id'];
    ...
    this._transportDate = map['transportdate'];
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    map['transportdate'] = _transportDate;
