class InformationSource {
  ...
  InformationSource(this._informationSourceId, this._name, this._description, this._status, this._createdBy, this._updatedBy, this._createdAt, this._updatedAt);

  // Getters
  int get id => _id;
  int get blockId => _informationSourceId;
  ...
  InformationSource.map(dynamic object) {
    this._informationSourceId = object['id'];
  ...
  InformationSource.fromMap(Map<String, dynamic> map) {
    this._informationSourceId = map['id'];
    this._name = map['name'];
  ...
  Map<String, dynamic> toMap() {
    ...
    map['information_source_id'] = this._informationSourceId;
    map['name'] = this._name;
