class ToiletPrivacy {
  ...
  ToiletPrivacy(this._toiletPrivacyId, this._name, this._description, this._status, this._createdBy, this._updatedBy, this._createdAt, this._updatedAt);

  // Getters
  int get id => _id;
  int get blockId => _toiletPrivacyId;
  ...
  ToiletPrivacy.map(dynamic object) {
    this._toiletPrivacyId = object['id'];
  ...
  ToiletPrivacy.fromMap(Map<String, dynamic> map) {
    this._toiletPrivacyId = map['id'];
    this._name = map['name'];
  ...
  Map<String, dynamic> toMap() {
    ...
    map['toilet_privacy_id'] = this._toiletPrivacyId;
    map['name'] = this._name;
