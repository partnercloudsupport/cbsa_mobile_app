class ToiletTypeCA {
  ...
  ToiletTypeCA(this._toiletTypeId, this._name, this._description, this._status, this._createdBy, this._updatedBy, this._createdAt, this._updatedAt);
  ...
  ToiletTypeCA.map(dynamic object) {
  ...
  ToiletTypeCA.fromMap(Map<String, dynamic> map) {
