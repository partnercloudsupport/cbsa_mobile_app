class Territory {
  ...
  Territory(this._territoryId, this._name, this._description, this._status, this._createdBy, this._updatedBy, this._createdAt, this._updatedAt);
  Territory.empty();
  ...
  Territory.map(dynamic object) {
    this._territoryId = object['id'];
  ...
  Territory.fromMap(Map<String, dynamic> map) {
