class PaidService {
  ...
  PaidService(this._paidServiceId, this._name, this._description, this._status, this._createdBy, this._updatedBy, this._createdAt, this._updatedAt);

  // Getters
  int get id => _id;
  int get blockId => _paidServiceId;
  ...
  PaidService.map(dynamic object) {
    this._paidServiceId = object['id'];
  ...
  PaidService.fromMap(Map<String, dynamic> map) {
    this._paidServiceId = map['id'];
    this._name = map['name'];
  ...
  Map<String, dynamic> toMap() {
    ...
    map['paid_service_id'] = this._paidServiceId;
    map['name'] = this._name;
