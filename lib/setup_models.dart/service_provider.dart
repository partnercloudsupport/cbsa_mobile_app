class ServiceProvider {
  ...
  ServiceProvider(this._serviceProviderId, this._name, this._description, this._status, this._createdBy, this._updatedBy, this._createdAt, this._updatedAt);
  ...
  ServiceProvider.map(dynamic object) {
    this._serviceProviderId = object['id'];
  ...
  ServiceProvider.fromMap(Map<String, dynamic> map) {
    this._serviceProviderId = map['id'];
    this._name = map['name'];
  ...
  Map<String, dynamic> toMap() {
    ...
    map['service_provider_id'] = this._serviceProviderId;
    map['name'] = this._name;
