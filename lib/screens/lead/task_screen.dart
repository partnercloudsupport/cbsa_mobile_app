...
import 'package:cbsa_mobile_app/screens/lead/update_task.dart';
...
class Task extends StatefulWidget {
  final Lead lead;
  Task({Key key, this.lead}) : super(key: key);
...
class _TaskState extends State<Task> {
  ...
  buildListView(TaskModel model, int index) {
    DateTime date = DateTime.parse(model.tasks[index]['duedate']);
