          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: TextFormField(
                textAlign: TextAlign.start,
                enabled: false,
                initialValue: snapshot.hasData? snapshot.data.name : '',
              ),
            ),
            SizedBox(
              height: 10.0,
                              ...
                              children: <Widget>[
                                CircleAvatar(
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () async {
                                      var url =
                                          'tel:${widget.lead.primaryTelephone}';
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: <Widget>[
                      ...
                      //         .toString()), //_getTerritory(widget.lead.territory).toString()),
                      _displayText(
                          'Sub Territory',
                          _getSubTerritory(widget.lead.subTerritory)
                              .toString()),
                      _displayText(
                          'Block', _getBlock(widget.lead.block).toString()),
