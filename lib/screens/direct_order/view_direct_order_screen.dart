...
class ViewDirectOrder extends StatefulWidget {
  final Lead lead;
  ViewDirectOrder({Key key, this.lead}) : super(key: key);

  @override
  ViewDirectOrderState createState() => ViewDirectOrderState();
}
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => UpdateDirectRecord(lead: widget.lead),
                                      ),
                                    );
                                  },
                                ),
...
//     );
  ...
  _itemSelected(String item) {
    if(item == 'Tasks') {
      Navigator.push(context, MaterialPageRoute(builder: (context) => DirectOrderTask(lead: widget.lead)));
    } else if(item == 'Edit') {
      // Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateDirectRecord(lead: widget.lead,)));
    } else if(item == 'Archive') {
      // showAlertDialog('archive', model, index)
      // Navigator.push(context, MaterialPageRoute(builder: (context) => NewTask(id: widget.lead.id,)));
    }
  }
